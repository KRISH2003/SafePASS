    ...
    return (
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                ...
                <p className='text-green-900 text-lg text-center'>All your passwords in one secure place - store, manage, and access them anytime.</p>
                    ...
                    {passwordArray.length === 0 && (
                        <div className="text-gray-700 mt-6">
                            ...
                            <p className="text-sm mt-1">
                                Start by adding your first credential above 🚀
                            </p>
                        </div>
                    )}
                    {passwordArray.length != 0 &&
                            ...
                            <table className="table-auto w-full rounded-md mb-10">
                                ...
                                <tbody className='bg-green-100'>
                                    {passwordArray.map((item, index) => {
                                        return <tr key={index}>
                                            <td className='py-2 border border-white text-center max-w-[200px]'>
